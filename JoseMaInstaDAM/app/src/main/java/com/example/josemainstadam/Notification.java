...
public class Notification extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newItems.add(new NewItem(R.drawable.machine, "Advances in AI Technology", "The latest developments in artificial intelligence are changing the way we interact with technology. From virtual assistants to autonomous vehicles, AI is everywhere.","Jhon Doe"));
